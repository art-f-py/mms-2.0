// Nicholas (1981) Mining Method Selection
// Nicholas, D.E. (1981). SME-AIME, New York, pp. 39-53.
// Ordem dos métodos (índice fixo):
// 0:OP  1:BC  2:SLS  3:SLC  4:LW  5:R&P  6:SKS  7:C&F  8:TS  9:SQS

export const NICHOLAS81_GEOMETRY = {
  shape: {
    options: {
  ...
  // Nicholas 81 não tem profundidade — campo exibido mas não usado no cálculo
};

export const NICHOLAS81_OREBODY = {
  rss: {
    options: {
...
export const NICHOLAS81_HANGINGWALL = {
  rss: {
    options: {
...
export const NICHOLAS81_FOOTWALL = {
  rss: {
    options: {
